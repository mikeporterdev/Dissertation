...
\citet[p.118]{nielsen1994usability} states that ``The actual effectiveness of a system is achieved when there is an appropriate balance between functionality and usability'', implying that in order to create a truly functional system there must be some focus on it's ease of use.
