...
\section{Risks}
%Generic risks, have more specifics
%%Learning curve for flask, rest api etc is too steep.
%%App could be a burden rather than a help, too busy messing with the app to do the chores. non-pervasive.
%%I'm making assumptions about the functionality of third party software (GCM).
%%SugarORM and GreenDAO was bad.
